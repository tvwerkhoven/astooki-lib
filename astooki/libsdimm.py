...
def mergeMaps(covmaps, slists, alists):
	"""
	Merge covariance maps generated by computeSdimmCovWeave() together into one.
	"""
	...
	print "mergeMap(): Got s: %s" % str(slist)
	log.prNot(log.INFO, "mergeMap(): Got a: %s" % str(alist))
	print "mergeMap(): Got a: %s" % str(alist)
